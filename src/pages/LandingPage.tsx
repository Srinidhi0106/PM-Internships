        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.08] text-slate-900 dark:text-white">
              ...
              <span className="text-orange-500">InternIQ Career </span>
              <span className="bg-gradient-to-r from-orange-500 via-teal-600 to-emerald-600 bg-clip-text text-transparent">
                Intelligence
              </span>
            </h1>
